...
win32 {
    ...
    !exists(libs/oboe/include/oboe/Oboe.h) {
         error("Error: The oboe submodule is not installed, Please run \"git submodule update --init\" first")
    }
